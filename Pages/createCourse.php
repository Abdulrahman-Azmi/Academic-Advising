...
<body>
    ...
    $newCourse = "INSERT INTO courses (courseid, classname, units, term, Course, Book, Web_Content) 
            VALUES (?, ?, ?, ?, ?, ?, ?)";

    $newCourseStmt = $connection->prepare($newCourse);
    $newCourseStmt->bind_param('ssissss', $courseid, $classname, $units, $term, $Course, $Book, $Web_Content );
