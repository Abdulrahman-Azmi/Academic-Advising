    ...
    <div class="row text-center">
        ...
        <div class="col-md-4">
            <div class="row extra-top">
                 <a href="searchcourseAdmin.php" class="btn-lg btn-primaryButts btn-block">View All Classes</a>
            </div>
            <div class="row extra-top">
                <a href="search_studentsAdmin.php" class="btn-lg btn-primaryButts btn-block">View All Students</a>
             </div>
             <div class="row extra-top">
                <a href="search_advisors.php" class="btn-lg btn-primaryButts btn-block">View All Advisors</a>
             </div>
        </div>
        <div class="col-md-4"></div>
    </div>
                ...
                <table id="studentList" class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $advid = $_SESSION['AdminID'];

                            $sql = " SELECT student.fname AS fname, student.lname AS lname, studentid, major,advid
                                     FROM student  ";
