        ...
        <div class="row text-center" style="margin-top: 20px;">
            ...
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <input type="search" id="search" value="" class="form-control" placeholder="Search for advisor">
                    </div>
                    <div class="col-md-4"></div>
                </div>
                                ...
                                <?php
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<tr>";
                                            echo "<td><a class='logout' href=advisor_form.php?advid=",urlencode($advid),">$advid</a></td>";
                                            echo "<td>$fname</td>";
                                            echo "<td>$lname</td>";
                                             echo "<td>$email</td>";
                                            echo "<td>$phone</td>";
