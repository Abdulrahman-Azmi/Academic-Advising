...
<?php 
    ...
    while($row = $result->fetch_assoc()){
        ...
        $depunits = $row['units'];
        $depterm = $row['term'];
        $depCourse = $row['Course'];
        $depBook = $row['Book'];
        $depWeb_Content = $row['Web_Content'];
    }
    ...
    if (!logged_in() || !isset($_SESSION['AdminID'])) {
        ...
        <nav class="navbar navbar-default navbar-custom">
            <div class="container-fluid"> 
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="Admin_home.php">Head_Of_Department</a>
                </div>
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>&nbsp;</li>
                        <li><a><?php echo $_SESSION['AdminID']; ?></a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div class="row">
                ...
                <div class="col-md-4 form">
                    <form method="post" action="updateCourse.php" enctype="multipart/form-data" >
                        ...
                        <fieldset class="form-group"> 
                            <label>Web_Content URL:</label>
                            <input type="text" class="form-control" name="Web_Content" placeholder="Web_Content" maxlength="128" value="<?php echo $depWeb_Content; ?>" autocomplete="off" >
                            <input type="hidden" name="oldWebContent" value="<?php echo $depWeb_Content; ?>"></input>
                        </fieldset>
                        <fieldset class="form-group"> 
                            <label>Course file:</label>
                            <input type="file" class="form-control" name="Course" placeholder="Course File" maxlength="50"  autocomplete="off" >
                            <input type="hidden" name="oldcourse"></input>
                        </fieldset>
                        </fieldset>
                        <fieldset class="form-group"> 
                            <label>Book file:</label>
                            <input type="file" class="form-control" name="Book" placeholder="Book File" maxlength="50"  autocomplete="off" >
                            <input type="hidden" name="oldcourse" ></input>
                        </fieldset>
