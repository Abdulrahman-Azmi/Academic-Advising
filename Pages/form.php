...
<head>
	...
	<meta http-equiv="Form-Page" content="text/html;" charset="UTF-8">
	<title>Form</title>
			    ...
			    <?php $startyear = $_SESSION['startyear']; ?>
				    ...
				    <th></th>
				  	...
				  	<tr>
						...
						<th class="table-title">Book</th>
						<th class="table-title">Web-Content</th>
					</tr>
					...
					while ($row = $result->fetch_array()) {
						...
						<tr> 
							...
							<td><?php echo  (!empty($Course))? "<a href='$Course' download><img src='img/svg-file.svg' width='50px'></a>": '' ; ?></td> 
							<td><?php echo  (!empty($book))? "<a href='$book' download><img src='img/svg-file.svg' width='50px'></a>": '' ; ?></td> 
							<td><?php echo (!empty($web_content))?  "<a href='$web_content' target='_blank'><img src='img/watch.svg'></a>": '' ;?></td> 
						</tr> 
						<?php
