                ...
                <div class="col-md-4 form">
                    <form method="post" action="createCourse.php" enctype="multipart/form-data">
                     <fieldset class="form-group"> 
                       ...
                       <fieldset class="form-group"> 
                            <input type="text" class="form-control" name="classname" placeholder="Class Name" autocomplete="off" >
                       </fieldset>
                       <fieldset class="form-group">
                        ...
                        <fieldset class="form-group"> 
                            <input type="text" class="form-control" name="Web_Content" placeholder="Web_Contetn {URL}" autocomplete="off" >
                       </fieldset>
                        </fieldset>
                        <fieldset class="form-group text-center">
                            <label for="chooseFile">Select University subject file</label>
                            <input type="file" class="form-control" name="Course" id="chooseFile">
                        </fieldset>
