                ...
                <div class="col-md-4 form">
                    <form method="post" action="createStudent.php">
                        <fieldset class="form-group"> 
                            <input type="text" class="form-control" name="studid" placeholder="Student ID" maxlength="10" minlength="4" autocomplete="off" required>
                        </fieldset>
                        <fieldset class="form-group"> 
                        ...
                        <fieldset class="form-group">
                            ...
                            <?php                         
                                ...
                                }else  echo "<option value='Waiting'>Waiting for advisor</option>";
                            ?>
                            </select>
                        </fieldset>
                        <fieldset class="form-group">
                        ...
                        <div class ="text-center">
                            ...
                            <input type="reset"  class="btn-lg btn-primary extra-top">
                        </div>
                    </form>
                </div>
                <div class="col-md-4">
